...
addpath('Master/Prosjektoppgave/dataset/patient30/') 

load 20190826T112026_IQ_Sepsis-4min_traces;
name1 = '26.08.2019'; Ts1 = Ts; Tmean1 = Tmean; Tmin1 = Tmin; Tmax1 = Tmax; delay1=0.20;

load 20190827T085347_IQ_Sepsis-4min_traces;
name2 = '27.08.2019'; Ts2 = Ts; Tmean2 = Tmean; Tmin2 = Tmin; Tmax2 = Tmax; delay2=0.20;

load 20190829T102710_IQ_Sepsis-4min_traces;
name3 = '29.08.2019'; Ts3 = Ts; Tmean3 = Tmean; Tmin3 = Tmin; Tmax3 = Tmax; delay3=0.20;
...
subplot(3,1,1);plot(T1_intp,R1_intp/mean(R1_intp));ylim([0.7,1.3]);grid();title(name1)
subplot(3,1,2);plot(T2_intp,R2_intp/mean(R2_intp));ylim([0.7,1.3]);grid();title(name2)
subplot(3,1,3);plot(T3_intp,R3_intp/mean(R3_intp));ylim([0.7,1.3]);grid();title(name3)
