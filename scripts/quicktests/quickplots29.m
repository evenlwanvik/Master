...
%load 20190820T095022_IQ_Sepsis-4min_traces; name1 = '19.01.2019'; delay=0.19;
%load 20190821T094833_IQ_Sepsis-4min_traces; name2 = '20.01.2019'; delay=0.19;
%load 20190821T164933_IQ_Sepsis 4min_traces; name3 = '21.01.2019'; delay=0.19;
%load 20190823T083952_IQ_Sepsis-4min_traces; name4 = '23.01.2019'; delay=0.19;
%load 20190823T134855_IQ_Sepsis-4min_traces; name5 = '20.01.2019'; delay=0.19;
%load 20190826T103731_IQ_Sepsis-4min_traces; name6 = '21.01.2019'; delay=0.19;
load 20190827T120656_IQ_Sepsis-4min_traces; name7 = '23.01.2019'; delay=0.19;
...
v_new = v_out(del+1:end-del);
p_new = p_out(del+1:end-del);
t_new = t(del+1:end-del);
figure(17); 
%title('23.01.2019')
yyaxis left; plot(t_new,p_new);ylim([52, 70])
