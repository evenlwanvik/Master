...
subplot(4,1,1);plot(T1_intp,R1_intp/mean(R1_intp));
ylim([0.5,1.5]);grid();title(name1);ylabel('SVR [(1)]');
subplot(4,1,2);plot(T2_intp,R2_intp/mean(R2_intp));
ylim([0.5,1.5]);grid();title(name2);ylabel('(1)');
subplot(4,1,3);plot(T3_intp,R3_intp/mean(R3_intp));
ylim([0.5,1.5]);grid();title(name3);ylabel('(1)');
subplot(4,1,4);plot(T4_intp,R4_intp/mean(R4_intp));
ylim([0.5,1.5]);grid();title(name4);ylabel('(1)');xlabel('Time [sec]')
...
figure(75);clf;%sgtitle('Patient 18 - Resistance');
subplot(4,1,1);plot(T1_intp,C1_intp/mean(C1_intp));
ylim([0.5,1.5]);grid();title(name1);ylabel('(1)');
subplot(4,1,2);plot(T2_intp,C2_intp/mean(C2_intp));
ylim([0.5,1.5]);grid();title(name2);ylabel('(1)');
subplot(4,1,3);plot(T3_intp,C3_intp/mean(C3_intp));
ylim([0.5,1.5]);grid();title(name3);ylabel('(1)');
subplot(4,1,4);plot(T4_intp,C4_intp/mean(C4_intp));
ylim([0.5,1.5]);grid();title(name4);ylabel('(1)');xlabel('Time [sec]')
