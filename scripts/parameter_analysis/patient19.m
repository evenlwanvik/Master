...
addpath('Master/Prosjektoppgave/dataset/patient19/') 
load 20190123T103020_IQ_Sepsis-4min_traces;
name1 = '19.01.2019'; Ts1 = Ts; Tmean1 = Tmean; Tmin1 = Tmin; Tmax1 = Tmax; delay1=0.20;
load 20190123T195334_IQ_Sepsis-4min_traces;
name2 = '20.01.2019'; Ts2 = Ts; Tmean2 = Tmean; Tmin2 = Tmin; Tmax2 = Tmax; delay2=0.20;
load 20190124T143824_IQ_Sepsis-4min_traces;
name3 = '21.01.2019'; Ts3 = Ts; Tmean3 = Tmean; Tmin3 = Tmin; Tmax3 = Tmax; delay3=0.20;
load 20190125T094538_IQ_Sepsis-4min_traces;
...
% find average
R1_dft_subset_mean_19 = mean(R1_dft_subset); 
R2_dft_subset_mean_19 = mean(R2_dft_subset); 
R3_dft_subset_mean_19 = mean(R3_dft_subset); 
R4_dft_subset_mean_19 = mean(R4_dft_subset);

R1_dft_subset_var_19 = mad(R1_dft_subset);
R2_dft_subset_var_19 = mad(R2_dft_subset);
R3_dft_subset_var_19 = mad(R3_dft_subset);
R4_dft_subset_var_19 = mad(R4_dft_subset);

R_mean = [R1_dft_subset_mean_19, R2_dft_subset_mean_19, R3_dft_subset_mean_19, R4_dft_subset_mean_19];
R_var = [R1_dft_subset_var_19, R2_dft_subset_var_19, R3_dft_subset_var_19, R4_dft_subset_var_19];
...
% find average
C1_dft_subset_mean_19 = mean(C1_dft_subset); 
C2_dft_subset_mean_19 = mean(C2_dft_subset); 
C3_dft_subset_mean_19 = mean(C3_dft_subset); 
C4_dft_subset_mean_19 = mean(C4_dft_subset);

C1_dft_subset_var_19 = mad(C1_dft_subset);
C2_dft_subset_var_19 = mad(C2_dft_subset);
C3_dft_subset_var_19 = mad(C3_dft_subset);
C4_dft_subset_var_19 = mad(C4_dft_subset);

C_mean = [C1_dft_subset_mean_19, C2_dft_subset_mean_19, C3_dft_subset_mean_19, C4_dft_subset_mean_19];
C_var = [C1_dft_subset_var_19, C2_dft_subset_var_19, C3_dft_subset_var_19, C4_dft_subset_var_19];
figure();
